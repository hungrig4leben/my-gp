...
if ( have_posts() ) : the_post();
    ...
    if ( $slides ) : ?>
        ...
        <div id="main" class="site">
            ...
            <a href="#" class="slider-arrow-left"><?php _e( 'Previous', 'gp' ); ?></a>
            <a href="#" class="slider-arrow-right"><?php _e( 'Next', 'gp' ); ?></a>
                                    ...
                                    <div class="viewport">
                                        ...
                                        if ( $data['description'] || $data['link'] || $data['link_portfolio'] ) : ?>
                                            ...
                                            <div class="animate-2"><?php
                                                ...
                                                $title = !empty( $data['link_title'] ) ? $data['link_title'] : __( 'View', 'gp' );
