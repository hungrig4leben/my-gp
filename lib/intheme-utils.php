...
if ( ! function_exists( 'it_get_post_thumbnail' ) ) {
     ...
     * Returns:
     *     false - if failed
     *     thumbnail URL - if $return_array == false
     *     array('src', 'width', 'height') - if $return_array == true
     */
    function it_get_post_thumbnail( $post_id, $size = 'thumbnail', $return_array = false ) {
